    ...
    <div className='containerGuides mb-12'>
      ...
      <div className="lg:w-3/4 w-11/12 m-auto h-auto my-10 lg:my-0 lg:mb-10">
        <div className='list'>
          ...
          <ul>
            <li><strong>Implementare</strong> i tipi di dato di JavaScript, i metodi predefiniti e le variabili.</li>
            <li><strong>Utilizzare</strong> le strutture condizionali per controllare il flusso di un programma in JavaScript.</li>
            <li><strong>Creare</strong> funzioni e passare dati attraverso di esse in modo efficiente.</li>
            <li><strong>Comprendere</strong> e utilizzare gli scope globali e a livello di blocco in JavaScript.</li>
            <li><strong>Lavorare</strong> con gli array per memorizzare e gestire dati complessi.</li>
            <li><strong>Utilizzare</strong> i cicli (loop) per eseguire blocchi di codice ripetutamente e automatizzare compiti.</li>
            <li><strong>Semplificare</strong> l&apos;iterazione sugli array tramite metodi degli iteratori.</li>
            <li><strong>Applicare</strong> la sintassi ES6 degli oggetti di JavaScript per modellare entità del mondo reale.</li>
          </ul>
        </div>
      </div>
